 ...
 <?php
  ...
  session_start();
    ...
    $Total_atlet = "SELECT * FROM data_siswa WHERE no_id "; 
    $Total_Kyurugi = "SELECT * FROM data_siswa WHERE kelas = 'Kyurugi' ";
    $Total_Poomsae = "SELECT * FROM data_siswa WHERE kelas = 'Poomsae' ";
    // Sum Siswa
	$result1 = mysqli_query($connect, $Total_atlet); 
	if ($result1) 
	{ 
    ...
    // Jumlah Laki Laki
	$result2 = mysqli_query($connect, $Total_Kyurugi); 
	if ($result2) 
	{ 
