...
if (isset($_GET['id'])) {
    $sqlSiswa = mysqli_query($connect, "SELECT * FROM spp WHERE idspp='$_GET[id]'");
    $ds = mysqli_fetch_array($sqlSiswa);
    $siswa = mysqli_query($connect, "SELECT * FROM data_siswa WHERE no_id='$ds[idsiswa]'");
    ...
    $pdf->Cell(0, 10, 'NOTA PEMBAYARAN SPP TAEKWONDO BUMIAJI', 0, 0, 'C');
